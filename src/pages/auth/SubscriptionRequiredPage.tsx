          ...
          <div className="space-y-6">
            ...
            >
              {pricingTiers.map((tier) => (
                ...
                >
                  {tier.popular && (
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-primary-500 text-white px-4 py-1 text-sm font-medium rounded-full">
                      Popular
                    </div>
                  )}
            ...
            <div className="mt-8 space-y-6">
              <Button
                ...
                className="bg-primary-600 hover:bg-primary-700 text-lg py-4 font-semibold"
              >
