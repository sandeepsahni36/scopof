              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Start 14-Day Free Trial</span>
                  </div>
                  <p className="text-sm text-gray-500">Try all features free for 14 days, then choose your plan</p>
                </div>
              </div>
            </label>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <div className="flex items-center">
                    ...
                    <span className="font-medium text-gray-900">Create Account (No Trial)</span>
                  </div>
                  <p className="text-sm text-gray-500">Choose your plan and start immediately</p>
                </div>
              </div>
            </label>
          </div>
