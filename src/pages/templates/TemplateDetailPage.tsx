  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {/* Full-width Template Information card */}
                ...
                <div className="space-y-4">
                  ...
                  {(selectedItem.type === 'single_choice' ||
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {(
                          (watch(`items.${selectedItemIndex}.options`) as RatingOption[]) ||
                          []
                          ...
                          <div key={optionIndex} className="flex items-center space-x-2">
                            ...
                            <div className="flex space-x-1">
                              {Object.entries(RATING_COLORS).map(([key, val]) => (
                                <button
                                  ...
                                  type="button"
                                  onClick={() =>
                                    updateOptionColor(selectedItemIndex!, optionIndex, val)
                                  }
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                removeOptionFromItem(selectedItemIndex!, optionIndex)
                              }
                              leftIcon={<Trash2 size={16} />}
                            />
                          </div>
                  ...
                  {selectedItem.type === 'photo' && (
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-xs text-gray-500">
                        During inspection, users can take a photo or upload from files.
                      </p>
                    </div>
                  )}
                  ...
                  {selectedItem.type === 'divider' && (
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <p className="text-xs text-gray-500">
                        Creates a visual separator between sections of your template.
                      </p>
                    </div>
                  )}
                </div>
