  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex min-h-screen">
        ...
        >
    // Create a mock PDF file for the report
    ...
    const mockFile = new File([mockPdfContent], fileName, { type: 'application/pdf' });
    
    // Use the uploadFile utility which handles RLS policies correctly
    const result = await uploadFile(mockFile, 'report', inspectionId);
