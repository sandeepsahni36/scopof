            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    An invitation email will be sent to the provided address. The user will be prompted to create an account. Once they sign up, they will automatically be added to your team with the selected role.
                  </p>
                  <p className="mt-2 font-semibold">
                    Note: This feature requires a Supabase Edge Function to be implemented for secure invitation handling.
                  </p>
                </div>
              </div>
            </div>
