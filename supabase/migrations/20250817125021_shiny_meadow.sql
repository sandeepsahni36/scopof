/*
  ...
  1. Dependency Fix
    ...
    - Then drops/recreates the function with schema fixes
    - Finally recreates the trigger

  2. Changes
    - Added explicit public schema references (your original fix)
...
-- THIRD: Recreate the function with your original changes
...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO public.admin ( -- Explicit public schema
      owner_id,
      billing_manager_id,
      company_name,
      subscription_tier,
    ...
    INSERT INTO public.team_members (admin_id, profile_id, role) -- Explicit public schema
