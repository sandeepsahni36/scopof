/*
  ...
  1. Custom types (enums) for various status fields
  2. Core tables for properties, templates, inspections, and reports
  3. Stripe integration tables for subscriptions and payments
  4. Authentication triggers and functions
  5. Row Level Security (RLS) policies
  6. Proper indexes for performance

  ## Tables created:
  - admin: Company/organization records
  ...
  - property_checklist_templates: Checklist-template associations
  - inspections: Inspection records
  - inspection_items: Individual inspection item responses
