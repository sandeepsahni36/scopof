...
-- Create ENUMs (with proper checks)
DO $$ BEGIN
...
-- Create Primary Keys (with existence checks)
DO $$ BEGIN
...
-- Create Unique Constraints (with existence checks)
DO $$ BEGIN
...
-- Create Check Constraints (with existence checks)
DO $$ BEGIN
...
-- Create Foreign Keys (with existence checks)
DO $$ BEGIN
