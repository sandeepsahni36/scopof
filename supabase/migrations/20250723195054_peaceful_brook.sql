/*
  ...
  This migration safely creates all necessary database objects while handling cases where they already exist.
  ...
  5. Constraints (with conditional creation)
...
-- Add comments to inspection columns
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Add foreign key constraints (with conditional creation)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'admin_owner_id_fkey' AND table_name = 'admin'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'admin_billing_manager_id_fkey' AND table_name = 'admin'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'team_members_profile_id_fkey' AND table_name = 'team_members'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'properties_admin_id_fkey' AND table_name = 'properties'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'template_categories_admin_id_fkey' AND table_name = 'template_categories'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'templates_admin_id_fkey' AND table_name = 'templates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'templates_category_id_fkey' AND table_name = 'templates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'template_items_parent_id_fkey' AND table_name = 'template_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'template_items_report_recipient_id_fkey' AND table_name = 'template_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'report_service_teams_admin_id_fkey' AND table_name = 'report_service_teams'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'property_checklists_property_id_fkey' AND table_name = 'property_checklists'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'property_checklist_templates_property_checklist_id_fkey' AND table_name = 'property_checklist_templates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'property_checklist_templates_template_id_fkey' AND table_name = 'property_checklist_templates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'inspections_property_id_fkey' AND table_name = 'inspections'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'inspections_inspector_id_fkey' AND table_name = 'inspections'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'inspections_property_checklist_id_fkey' AND table_name = 'inspections'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'inspection_items_inspection_id_fkey' AND table_name = 'inspection_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'inspection_items_template_item_id_fkey' AND table_name = 'inspection_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'reports_inspection_id_fkey' AND table_name = 'reports'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM information_schema.table_constraints 
        WHERE constraint_name = 'stripe_customers_user_id_fkey' AND table_name = 'stripe_customers'
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'admin_owner_full_access' AND tablename = 'admin'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'admin_postgres_access' AND tablename = 'admin'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'profiles_postgres_all' AND tablename = 'profiles'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'team_members_admin_manage' AND tablename = 'team_members'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'team_members_own_record' AND tablename = 'team_members'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'team_members_postgres_access' AND tablename = 'team_members'
    ) THEN
...
-- Create additional policies for other tables
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'properties_manage_admins' AND tablename = 'properties'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'properties_postgres_all' AND tablename = 'properties'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'templates_postgres_all' AND tablename = 'templates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'template_items_postgres_all' AND tablename = 'template_items'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'reports_postgres_all' AND tablename = 'reports'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'stripe_customers_postgres_all' AND tablename = 'stripe_customers'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'stripe_subscriptions_postgres_all' AND tablename = 'stripe_subscriptions'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies WHERE policyname = 'stripe_orders_postgres_all' AND tablename = 'stripe_orders'
    ) THEN
...
BEGIN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_template_categories_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_template_items_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_report_service_teams_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_property_checklists_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_property_checklist_templates_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_inspections_updated_at'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'update_inspection_items_updated_at'
    ) THEN
...
-- Create auth triggers (CRITICAL for user registration)
DO $$
BEGIN
    IF NOT EXISTS (
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger WHERE tgname = 'on_auth_user_verified'
    ) THEN
