/*
  # Create demo templates function

  1. Function Definition
    - Creates the `create_demo_templates` function that was missing
    - Takes admin_id as parameter and creates demo templates for new companies
    - Includes all the specific template structures you had before
  ...
  3. Template Items
    - Each template includes comprehensive item lists with proper types
    - Includes single_choice, multiple_choice, photo, number, and divider types
    - Proper color coding for rating options
    - Sequential ordering for all items
*/
